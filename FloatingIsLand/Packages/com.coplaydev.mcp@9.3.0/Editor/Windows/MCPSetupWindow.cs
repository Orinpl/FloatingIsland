...
namespace MCPForUnity.Editor.Windows
{
    ...
    public class MCPSetupWindow : EditorWindow
    {
        ...
        private void UpdateUI()
        {
            ...
            {
                statusMessage.text = "âœ?All requirements met! MCP for Unity is ready to use.";
                statusMessage.style.color = new StyleColor(Color.green);
                installationSection.style.display = DisplayStyle.None;
            }
            else
            {
                statusMessage.text = "âš?Missing dependencies. MCP for Unity requires all dependencies to function.";
